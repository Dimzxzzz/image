...
import { faServer, faShieldAlt, faBolt, faNetworkWired, faCog, faKey, faSignOutAlt, faChartLine } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    <div className="vax-stat-card">
                        <div className="flex items-center justify-between">
                            ...
                            <FontAwesomeIcon icon={faServer} className="text-blue-400 text-xl" />
                        </div>
                    </div>
                    ...
                    <div className="vax-stat-card">
                        <div className="flex items-center justify-between">
                            ...
                            <FontAwesomeIcon icon={faBolt} className="text-green-400 text-xl" />
                        </div>
                    </div>
                    ...
                    <div className="vax-stat-card">
                        <div className="flex items-center justify-between">
                            ...
                            <FontAwesomeIcon icon={faChartLine} className="text-purple-400 text-xl" />
                        </div>
                    </div>
                    ...
                    <div className="vax-stat-card">
                        <div className="flex items-center justify-between">
                            ...
                            <FontAwesomeIcon icon={faNetworkWired} className="text-yellow-400 text-xl" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="vax-card">
                        <h2 className="text-lg font-bold text-white mb-4 flex items-center">
                            <FontAwesomeIcon icon={faShieldAlt} className="mr-3 text-blue-400" />
                            Plan Information
                        </h2>
                        <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                <div className="flex items-center">
                                    <FontAwesomeIcon icon={faKey} className="mr-3 text-blue-400" />
                                    <span>API Keys</span>
                                </div>
                            ...
                            >
                                <div className="flex items-center">
                                    <FontAwesomeIcon icon={faCog} className="mr-3 text-green-400" />
...
import { useStoreState } from 'easy-peasy';
import { ApplicationStore } from '@/state';
import { faShieldAlt, faGamepad, faServer } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-900" 
            ...
            <div className="text-center mb-8">
                <div className="flex items-center justify-center mb-4">
                    <FontAwesomeIcon icon={faShieldAlt} className="text-blue-500 text-4xl mr-3" />
                                ...
                                <div className="flex items-start">
                                    <div className="mr-4 mt-1">
                                        <div className="w-10 h-10 rounded-full bg-purple-900/30 flex items-center justify-center">
                                            <FontAwesomeIcon icon={faServer} className="text-purple-400" />
                                        </div>
                                    </div>
                                    <div>
...
# ============================================
log_message "${YELLOW}Memperbarui admin dashboard...${NC}"

ADMIN_FILE="$PTERO_PATH/resources/scripts/components/admin/AdminContainer.tsx"
if [ -f "$ADMIN_FILE" ]; then
    mv "$ADMIN_FILE" "${ADMIN_FILE}.backup"
fi

cat > "$ADMIN_FILE" << 'EOF'
import React from 'react';
import { faCogs, faUsers, faServer, faChartBar, faShieldAlt, faDatabase, faNetworkWired, faCog } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import PageContentBlock from '@/components/elements/PageContentBlock';
import { Link } from 'react-router-dom';
...
export default () => {
    ...
    const quickActions = [
        { icon: faUsers, title: 'Manage Users', desc: 'View and manage all users', link: '/admin/users', color: 'blue' },
        { icon: faServer, title: 'Nodes', desc: 'Configure server nodes', link: '/admin/nodes', color: 'green' },
        { icon: faCogs, title: 'Settings', desc: 'Panel configuration', link: '/admin/settings', color: 'purple' },
        { icon: faShieldAlt, title: 'Security', desc: 'Security settings', link: '/admin/security', color: 'red' },
        { icon: faDatabase, title: 'Database', desc: 'Database management', link: '/admin/database', color: 'yellow' },
        { icon: faNetworkWired, title: 'Networking', desc: 'Network settings', link: '/admin/network', color: 'indigo' },
    ];
    ...
    return (
        <PageContentBlock title="Admin Dashboard">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-400">Complete management and monitoring system</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div className="vax-stat-card">
                    <div className="flex items-center justify-between">
                        ...
                        <FontAwesomeIcon icon={faServer} className="text-green-400 text-xl" />
                    </div>
                </div>
                ...
                <div className="vax-stat-card">
                    <div className="flex items-center justify-between">
                        <div>
                            <div className="text-sm text-purple-300 mb-1">STORAGE USED</div>
                            <div className="text-2xl font-bold">{adminStats.storageUsed}</div>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {quickActions.map((action, index) => (
                        <Link
                            key={index}
                            to={action.link}
                            className="group p-4 bg-gray-900/50 hover:bg-gray-800 rounded-xl border border-gray-800 hover:border-blue-500 transition-all duration-300 transform hover:-translate-y-1"
                        >
                            <div className="flex items-center">
                                <div className={`mr-4 p-3 rounded-lg bg-${action.color}-900/30 group-hover:bg-${action.color}-900/50`}>
                                    <FontAwesomeIcon icon={action.icon} className={`text-${action.color}-400 text-lg`} />
                                </div>
                                <div>
                                    <div className="font-bold text-white group-hover:text-blue-300">{action.title}</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="vax-card">
                    ...
                    <div className="space-y-4">
                        <div className="flex justify-between items-center pb-3 border-b border-gray-800">
                            <span className="text-gray-400">Panel Version</span>
                            <span className="text-white">VAX 2.0.1</span>
                        </div>
                        <div className="flex justify-between items-center pb-3 border-b border-gray-800">
                        ...
                        <div className="flex justify-between items-center pb-3 border-b border-gray-800">
                            ...
                            <span className="text-white">MySQL 8.0</span>
                        </div>
                        <div className="flex justify-between items-center">
                ...
                <div className="vax-card">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="px-3 py-1 bg-green-900/30 text-green-400 text-xs rounded-full">ACTIVE</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-gray-400">DDoS Protection</span>
                            <span className="px-3 py-1 bg-green-900/30 text-green-400 text-xs rounded-full">ENABLED</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-gray-400">SSL/TLS</span>
                            <span className="px-3 py-1 bg-green-900/30 text-green-400 text-xs rounded-full">VALID</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-gray-400">Audit Logging</span>
                            <span className="px-3 py-1 bg-blue-900/30 text-blue-400 text-xs rounded-full">ACTIVE</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* FOOTER NOTE */}
            <div className="mt-8 pt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
                <p>VAXSTRESSER Admin Panel v2.0 • Enterprise Edition</p>
                <p className="text-xs mt-1">All system activities are logged and monitored</p>
            </div>
        </PageContentBlock>
    );
};
...
log_message "${GREEN}Admin dashboard berhasil diperbarui${NC}"

# ============================================
# 5. INSTALL SECURITY PATCH (File Controller)
# ============================================
